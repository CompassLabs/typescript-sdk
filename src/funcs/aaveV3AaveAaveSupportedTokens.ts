 ...
 */
export function aaveV3AaveAaveSupportedTokens(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V1AaveAaveSupportedTokensRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/aave/aave_supported_tokens")();
