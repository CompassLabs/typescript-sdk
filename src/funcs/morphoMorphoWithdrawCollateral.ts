 ...
 *                     </Info>
 */
export function morphoMorphoWithdrawCollateral(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.MorphoWithdrawCollateralRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/morpho/withdraw_collateral")();
