 ...
 */
export function aerodromeSlipstreamAerodromeSlipstreamLiquidityProvisionPositions(
  client: CompassApiSDKCore,
  request: operations.V1AerodromeSlipstreamLiquidityProvisionPositionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.AerodromeLPPositionsResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.AerodromeLPPositionsResponse$inboundSchema),
