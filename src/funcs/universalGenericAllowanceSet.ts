 ...
 */
export function universalGenericAllowanceSet(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.SetAllowanceRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/generic/allowance/set")();
  ...
  const context = {
    ...
    operationID: "v1_generic_allowance_set",
    oAuth2Scopes: [],
