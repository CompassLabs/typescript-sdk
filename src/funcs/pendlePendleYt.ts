 ...
 *                     </Info>
 */
export function pendlePendleYt(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.PendleTradeYtRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/pendle/yt")();
