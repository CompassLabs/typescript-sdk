 ...
 */
export function uniswapV3UniswapLiquidityProvisionPositions(
  client: CompassApiSDKCore,
  request: operations.V1UniswapLiquidityProvisionPositionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.UniswapLPPositionsInfoResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V1UniswapLiquidityProvisionPositionsRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/v1/uniswap/liquidity_provision/positions")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.UniswapLPPositionsInfoResponse$inboundSchema),
