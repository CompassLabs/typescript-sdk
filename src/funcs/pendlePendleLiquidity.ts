 ...
 *                     </Info>
 */
export function pendlePendleLiquidity(
  client: CompassApiSDKCore,
  request: components.PendleManageLiquidityRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.PendleTxResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.PendleManageLiquidityRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/pendle/liquidity")();
  ...
  const context = {
    ...
    operationID: "v1_pendle_liquidity",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.PendleTxResponse$inboundSchema),
