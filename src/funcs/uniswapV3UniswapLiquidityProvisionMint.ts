 ...
 *                     </Info>
 */
export function uniswapV3UniswapLiquidityProvisionMint(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.UniswapMintLiquidityProvisionRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/uniswap/liquidity_provision/mint")();
  ...
  const context = {
    ...
    operationID: "v1_uniswap_liquidity_provision_mint",
    oAuth2Scopes: [],
