 ...
 * - Whitelist status
 */
export function morphoMorphoMarket(
  client: CompassApiSDKCore,
  request: operations.V1MorphoMarketRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.MorphoGetMarketResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V1MorphoMarketRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/morpho/market")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.MorphoGetMarketResponse$inboundSchema),
