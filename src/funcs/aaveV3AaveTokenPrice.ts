 ...
 * Aave.
 */
export function aaveV3AaveTokenPrice(
  client: CompassApiSDKCore,
  request: operations.V1AaveTokenPriceRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.AaveTokenPriceResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V1AaveTokenPriceRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/aave/token_price")();
  ...
  const context = {
    ...
    operationID: "v1_aave_token_price",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.AaveTokenPriceResponse$inboundSchema),
