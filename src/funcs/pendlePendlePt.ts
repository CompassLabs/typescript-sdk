 ...
 *                     </Info>
 */
export function pendlePendlePt(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.PendleTradePtRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/pendle/pt")();
