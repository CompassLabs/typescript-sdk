 ...
 */
export function aaveV3AaveUserPositionPerToken(
  client: CompassApiSDKCore,
  request: operations.V1AaveUserPositionPerTokenRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.AaveUserPositionPerTokenResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V1AaveUserPositionPerTokenRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/aave/user_position_per_token")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.AaveUserPositionPerTokenResponse$inboundSchema),
