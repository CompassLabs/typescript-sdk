 ...
 */
export function aaveV3AaveReserveOverview(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V1AaveReserveOverviewRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/aave/reserve_overview")();
  ...
  const context = {
    ...
    operationID: "v1_aave_reserve_overview",
    oAuth2Scopes: [],
