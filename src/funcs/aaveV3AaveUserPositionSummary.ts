 ...
 */
export function aaveV3AaveUserPositionSummary(
  client: CompassApiSDKCore,
  request: operations.V1AaveUserPositionSummaryRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.AaveUserPositionSummaryResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V1AaveUserPositionSummaryRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/aave/user_position_summary")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.AaveUserPositionSummaryResponse$inboundSchema),
