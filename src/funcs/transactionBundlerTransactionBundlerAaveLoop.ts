 ...
 */
export function transactionBundlerTransactionBundlerAaveLoop(
  client: CompassApiSDKCore,
  request: components.AaveLoopRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ResponseV1TransactionBundlerAaveLoop,
...
> {
  ...
  const path = pathToFunc("/v1/transaction_bundler/aave/loop")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ResponseV1TransactionBundlerAaveLoop$inboundSchema),
