 ...
 */
export function morphoMorphoVaults(
  client: CompassApiSDKCore,
  request: operations.V1MorphoVaultsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.MorphoGetVaultsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V1MorphoVaultsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/morpho/vaults")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.MorphoGetVaultsResponse$inboundSchema),
