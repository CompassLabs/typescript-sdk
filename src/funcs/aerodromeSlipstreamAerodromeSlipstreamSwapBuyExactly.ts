 ...
 *                     </Info>
 */
export function aerodromeSlipstreamAerodromeSlipstreamSwapBuyExactly(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.AerodromeSlipstreamBuyExactlyRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/aerodrome_slipstream/swap/buy_exactly")();
