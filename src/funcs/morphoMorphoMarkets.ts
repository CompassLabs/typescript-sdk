 ...
 */
export function morphoMorphoMarkets(
  client: CompassApiSDKCore,
  request: operations.V1MorphoMarketsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.MorphoGetMarketsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V1MorphoMarketsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/morpho/markets")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.MorphoGetMarketsResponse$inboundSchema),
