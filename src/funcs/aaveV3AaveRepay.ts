 ...
 *                     </Info>
 */
export function aaveV3AaveRepay(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.AaveRepayRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/aave/repay")();
