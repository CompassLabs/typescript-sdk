 ...
 *                     </Info>
 */
export function pendlePendleRedeemYield(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.PendleRedeemYieldRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/pendle/redeem_yield")();
  ...
  const context = {
    ...
    operationID: "v1_pendle_redeem_yield",
    oAuth2Scopes: [],
