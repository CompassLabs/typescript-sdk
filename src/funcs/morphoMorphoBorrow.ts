 ...
 *                     </Info>
 */
export function morphoMorphoBorrow(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.MorphoBorrowRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/morpho/borrow")();
