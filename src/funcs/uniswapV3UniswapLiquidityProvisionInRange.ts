 ...
 */
export function uniswapV3UniswapLiquidityProvisionInRange(
  client: CompassApiSDKCore,
  request: operations.V1UniswapLiquidityProvisionInRangeRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.UniswapCheckInRangeResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V1UniswapLiquidityProvisionInRangeRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/uniswap/liquidity_provision/in_range")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.UniswapCheckInRangeResponse$inboundSchema),
