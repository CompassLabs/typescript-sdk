 ...
 *                     </Info>
 */
export function morphoMorphoSupplyCollateral(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.MorphoSupplyCollateralRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/morpho/supply_collateral")();
  ...
  const context = {
    ...
    operationID: "v1_morpho_supply_collateral",
    oAuth2Scopes: [],
