 ...
 *                     </Info>
 */
export function skySkyWithdraw(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.SkyWithdrawRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/sky/withdraw")();
