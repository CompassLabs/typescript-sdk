 ...
 *                     </Info>
 */
export function uniswapV3UniswapLiquidityProvisionWithdraw(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.UniswapWithdrawLiquidityProvisionRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/uniswap/liquidity_provision/withdraw")();
  ...
  const context = {
    ...
    operationID: "v1_uniswap_liquidity_provision_withdraw",
    oAuth2Scopes: [],
