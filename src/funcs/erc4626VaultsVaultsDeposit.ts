 ...
 *                     </Info>
 */
export function erc4626VaultsVaultsDeposit(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.VaultDepositRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/vaults/deposit")();
