 ...
 */
export function smartAccountSmartAccountBatchedUserOperations(
...
> {
  ...
  const path = pathToFunc("/v1/smart_account/batched_user_operations")();
  ...
  const context = {
    ...
    operationID: "v1_smart_account_batched_user_operations",
    oAuth2Scopes: [],
