 ...
 *                     </Info>
 */
export function uniswapV3UniswapSwapSellExactly(
  client: CompassApiSDKCore,
  request: components.UniswapSellExactlyRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.UniswapSellExactlyTransactionResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.UniswapSellExactlyRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/uniswap/swap/sell_exactly")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.UniswapSellExactlyTransactionResponse$inboundSchema),
