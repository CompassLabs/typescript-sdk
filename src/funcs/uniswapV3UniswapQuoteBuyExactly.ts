 ...
 */
export function uniswapV3UniswapQuoteBuyExactly(
  client: CompassApiSDKCore,
  request: operations.V1UniswapQuoteBuyExactlyRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.UniswapBuyQuoteInfoResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V1UniswapQuoteBuyExactlyRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/uniswap/quote/buy_exactly")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.UniswapBuyQuoteInfoResponse$inboundSchema),
