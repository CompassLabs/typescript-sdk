 ...
 */
export function aaveV3AaveStdRate(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V1AaveStdRateRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/aave/std_rate")();
