 ...
 *                     </Info>
 */
export function aaveV3AaveBorrow(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.AaveBorrowRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/aave/borrow")();
