 ...
 * the quote endpoint.
 */
export function aerodromeSlipstreamAerodromeSlipstreamPoolPrice(
  client: CompassApiSDKCore,
  request: operations.V1AerodromeSlipstreamPoolPriceRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.AerodromeSlipstreamPoolPriceResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V1AerodromeSlipstreamPoolPriceRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v1/aerodrome_slipstream/pool_price")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.AerodromeSlipstreamPoolPriceResponse$inboundSchema),
