 ...
 *                     </Info>
 */
export function uniswapV3UniswapSwapBuyExactly(
  client: CompassApiSDKCore,
  request: components.UniswapBuyExactlyRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.UniswapBuyExactlyTransactionResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.UniswapBuyExactlyRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.UniswapBuyExactlyTransactionResponse$inboundSchema),
