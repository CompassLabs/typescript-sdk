 ...
 */
export function morphoMorphoWithdraw(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.MorphoWithdrawRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/morpho/withdraw")();
  ...
  const context = {
    ...
    operationID: "v1_morpho_withdraw",
    oAuth2Scopes: [],
