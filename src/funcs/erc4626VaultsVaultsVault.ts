 ...
 */
export function erc4626VaultsVaultsVault(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V1VaultsVaultRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/vaults/vault")();
