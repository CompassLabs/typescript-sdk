...
> {
  const parsed = safeParse(
    request,
    (value) => components.SkyDepositRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/sky/deposit")();
