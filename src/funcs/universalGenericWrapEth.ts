 ...
 */
export function universalGenericWrapEth(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.WrapEthRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/generic/wrap_eth")();
  ...
  const context = {
    ...
    operationID: "v1_generic_wrap_eth",
    oAuth2Scopes: [],
