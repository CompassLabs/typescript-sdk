 ...
 *                     </Info>
 */
export function aaveV3AaveSupply(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.AaveSupplyRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/aave/supply")();
